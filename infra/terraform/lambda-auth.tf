locals {
  ...
  auth_lambda_source_files = [
    "${path.module}/../../lambda/auth/package.json",
    "${path.module}/../../lambda/auth/package-lock.json",
    "${path.module}/../../lambda/auth/sign/handler.js",
    "${path.module}/../../lambda/auth/authorizer/handler.js",
    "${path.module}/../../lambda/auth/shared/config.js",
    "${path.module}/../../lambda/auth/shared/jwt.js",
  ]
